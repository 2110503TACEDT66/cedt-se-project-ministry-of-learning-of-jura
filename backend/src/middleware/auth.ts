...
export async function checkSuperUserToken(req: Request,res: Response,next: NextFunction){
...
export async function checkTokenIfExists(req: Request,res: Response,next: NextFunction){
    let token=getTokenFromReq(req);
    if(token==null){
        return next();
    }
