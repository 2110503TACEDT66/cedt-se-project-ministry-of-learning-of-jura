...
//@access : Private
export async function superUserLogin(req: Request,res: Response,next: NextFunction){
...
function responseWithToken(user: User & Document,statusCode: number,res: Response){
...
function responseWithTokenSuperUser(superuser: {superuser:string},statusCode: number,res: Response){
